...
class SoundAQnet_block2(nn.Module):
    def __init__(self, max_node_num, node_emb_dim = 256,
        ...
        super(SoundAQnet_block2, self).__init__()
        ...
        self.embedding_h = nn.Linear(32, hidden_dim)
        ...
        layer2345_num = 96
        self.fc_residual_mel_k3 = nn.Linear(96, node_emb_dim, bias=True)
        self.fc_residual_mel_k5 = nn.Linear(layer2345_num, node_emb_dim, bias=True)
        self.fc_residual_mel_k7 = nn.Linear(layer2345_num, node_emb_dim, bias=True)
        self.fc_residual_mel_k9 = nn.Linear(layer2345_num, node_emb_dim, bias=True)

        self.fc_residual_loudness_k3 = nn.Linear(layer2345_num, node_emb_dim, bias=True)
        self.fc_residual_loudness_k5 = nn.Linear(layer2345_num, node_emb_dim, bias=True)
        self.fc_residual_loudness_k7 = nn.Linear(layer2345_num, node_emb_dim, bias=True)
        self.fc_residual_loudness_k9 = nn.Linear(layer2345_num, node_emb_dim, bias=True)
...
class SoundAQnet_block4(nn.Module):
    def __init__(self, max_node_num, node_emb_dim=256,
                 hidden_dim=32,
                 out_dim=64,
                 n_layers=3,
                 event_class=len(config.event_labels),
                 scene_class=len(config.scene_labels), each_emotion_class=config.each_emotion_class_num,
                 batchnormal=False):

        super(SoundAQnet_block4, self).__init__()
        ...
        self.conv_block2 = ConvBlock_dilation(in_channels=16, out_channels=32, padding=(0, 0), dilation=(2, 1))
        self.conv_block3 = ConvBlock_dilation(in_channels=32, out_channels=64, padding=(0, 0), dilation=(3, 1))
        self.conv_block4 = ConvBlock_dilation(in_channels=64, out_channels=128, padding=(1, 1))
        self.k_3_freq_to_1 = nn.Linear(frequency_num, frequency_emb_dim, bias=True)
        ...
        self.conv_block3_kernel_5 = ConvBlock_dilation(in_channels=32, out_channels=64, kernel_size=kernel_size,
                                                       padding=(0, 1), dilation=(3, 1))
        self.conv_block4_kernel_5 = ConvBlock_dilation(in_channels=64, out_channels=128,
                                                       kernel_size=kernel_size, padding=(0, 2))
        self.k_5_freq_to_1 = nn.Linear(frequency_num, frequency_emb_dim, bias=True)
        ...
        self.conv_block3_kernel_7 = ConvBlock_dilation(in_channels=32, out_channels=64, kernel_size=kernel_size,
                                                       padding=(0, 3), dilation=(3, 1))
        self.conv_block4_kernel_7 = ConvBlock_dilation(in_channels=64, out_channels=128,
                                                       kernel_size=kernel_size, padding=(0, 3))
        self.k_7_freq_to_1 = nn.Linear(frequency_num, frequency_emb_dim, bias=True)
        ...
        self.conv_block2_kernel_9 = ConvBlock_dilation(in_channels=16, out_channels=32, kernel_size=kernel_size,
                                                       padding=(0, 3), dilation=(2, 1))
        self.conv_block3_kernel_9 = ConvBlock_dilation(in_channels=32, out_channels=64, kernel_size=kernel_size,
                                                       padding=(0, 4), dilation=(3, 1))
        self.conv_block4_kernel_9 = ConvBlock_dilation(in_channels=64, out_channels=128,
                                                       kernel_size=kernel_size, padding=(0, 4))
        self.k_9_freq_to_1 = nn.Linear(12, frequency_emb_dim, bias=True)

        # ---------------- loudness -----------------------------------------------------------------------------------
        # --------------------------------------------------------------------------------------------------------
        self.conv_block1_loudness = ConvBlock(kernel_size=(3, 1), padding=(0, 0), in_channels=1, out_channels=16)
        self.conv_block2_loudness = ConvBlock_dilation(kernel_size=(3, 1), in_channels=16, out_channels=32,
                                                       padding=(0, 0),
                                                       dilation=(2, 1))
        self.conv_block3_loudness = ConvBlock_dilation(kernel_size=(3, 1), in_channels=32, out_channels=64,
                                                       padding=(0, 0),
                                                       dilation=(3, 1))
        self.conv_block4_loudness = ConvBlock_dilation(in_channels=64, out_channels=128,
        ...
        self.conv_block1_kernel_5_loudness = ConvBlock(in_channels=1, out_channels=16,
                                                       kernel_size=kernel_size, padding=(0, 0))
        self.conv_block2_kernel_5_loudness = ConvBlock_dilation(in_channels=16, out_channels=32,
                                                                kernel_size=kernel_size,
                                                                padding=(0, 0), dilation=(2, 1))
        self.conv_block3_kernel_5_loudness = ConvBlock_dilation(in_channels=32, out_channels=64,
                                                                kernel_size=kernel_size,
                                                                padding=(0, 0), dilation=(3, 1))
        self.conv_block4_kernel_5_loudness = ConvBlock_dilation(in_channels=64, out_channels=128,
                                                                kernel_size=kernel_size, padding=(0, 0))
        ...
        self.conv_block1_kernel_7_loudness = ConvBlock(in_channels=1, out_channels=16,
                                                       kernel_size=kernel_size, padding=(0, 0))
        self.conv_block2_kernel_7_loudness = ConvBlock_dilation(in_channels=16, out_channels=32,
                                                                kernel_size=kernel_size,
                                                                padding=(0, 0), dilation=(2, 1))
        self.conv_block3_kernel_7_loudness = ConvBlock_dilation(in_channels=32, out_channels=64,
                                                                kernel_size=kernel_size,
                                                                padding=(0, 0), dilation=(3, 1))
        self.conv_block4_kernel_7_loudness = ConvBlock_dilation(in_channels=64, out_channels=128,
                                                                kernel_size=kernel_size, padding=(0, 0))
        ...
        self.conv_block1_kernel_9_loudness = ConvBlock(in_channels=1, out_channels=16,
                                                       kernel_size=kernel_size, padding=(0, 0))
        self.conv_block2_kernel_9_loudness = ConvBlock_dilation(in_channels=16, out_channels=32,
                                                                kernel_size=kernel_size,
                                                                padding=(0, 0), dilation=(2, 1))
        self.conv_block3_kernel_9_loudness = ConvBlock_dilation(in_channels=32, out_channels=64,
                                                                kernel_size=kernel_size,
                                                                padding=(0, 0), dilation=(3, 1))
        self.conv_block4_kernel_9_loudness = ConvBlock_dilation(in_channels=64, out_channels=128,
                                                                kernel_size=kernel_size, padding=(0, 0))
        ...
        # self.embedding_h = nn.Linear(in_dim, hidden_dim)
        self.embedding_h = nn.Linear(128, hidden_dim)
        ...
        layer2345_num = 192
        self.fc_residual_mel_k3 = nn.Linear(layer2345_num, node_emb_dim, bias=True)
        self.fc_residual_mel_k5 = nn.Linear(layer2345_num, node_emb_dim, bias=True)
        self.fc_residual_mel_k7 = nn.Linear(layer2345_num, node_emb_dim, bias=True)
        self.fc_residual_mel_k9 = nn.Linear(layer2345_num, node_emb_dim, bias=True)
    ...
    def forward(self, input, batch_x_loudness, batch_graph):
        ...
        batch_x = x
        """
        torch.Size([32, 64, 734, 10]) 

        torch.Size([32, 128, 730, 6]) 

        torch.Size([32, 64, 716, 10]) 

        torch.Size([32, 128, 700, 2]) 

        torch.Size([32, 64, 699, 14]) 

        torch.Size([32, 128, 675, 2]) 

        torch.Size([32, 64, 1412, 28]) 

        torch.Size([32, 128, 1380, 12]) 

        torch.Size([32, 64, 3733, 1]) 

        torch.Size([32, 128, 3725, 1]) 

        torch.Size([32, 64, 3716, 1]) 

        torch.Size([32, 128, 3700, 1]) 

        torch.Size([32, 64, 3699, 1]) 

        torch.Size([32, 128, 3675, 1]) 

        torch.Size([32, 64, 3682, 1]) 

        torch.Size([32, 128, 3650, 1]) 
        """
        # print(x.size())  # torch.Size([32, 1, 3001, 64])  (batch, channels, frames, freqs.)
        x_k_3 = self.conv_block1(batch_x, pool_size=(2, 2), pool_type='avg')
        x_k_3 = F.dropout(x_k_3, p=0.2, training=self.training)
        ...
        x_k_3 = self.conv_block3(x_k_3, pool_size=(1, 1), pool_type='avg')
        x_k_3 = F.dropout(x_k_3, p=0.2, training=self.training)
        # print(x_k_3.size(), '\n')  # torch.Size([32, 64, 367, 44])

        x_k_3 = self.conv_block4(x_k_3, pool_size=(1, 1), pool_type='avg')
        x_k_3 = F.dropout(x_k_3, p=0.2, training=self.training)
        # print(x_k_3.size(), '\n')
        ...
        x_k_5 = self.conv_block3_kernel_5(x_k_5, pool_size=(1, 1), pool_type='avg')
        x_k_5 = F.dropout(x_k_5, p=0.2, training=self.training)
        # print(x_k_5.size(), '\n')  # torch.Size([8, 256, 358, 32])

        x_k_5 = self.conv_block4_kernel_5(x_k_5, pool_size=(1, 1), pool_type='avg')
        x_k_5 = F.dropout(x_k_5, p=0.2, training=self.training)
        # print(x_k_5.size(), '\n')
        ...
        x_k_7 = self.conv_block3_kernel_7(x_k_7, pool_size=(1, 1), pool_type='avg')
        x_k_7 = F.dropout(x_k_7, p=0.2, training=self.training)
        # print(x_k_7.size(), '\n')  # torch.Size([8, 256, 349, 20])

        x_k_7 = self.conv_block4_kernel_7(x_k_7, pool_size=(1, 1), pool_type='avg')
        x_k_7 = F.dropout(x_k_7, p=0.2, training=self.training)
        # print(x_k_7.size(), '\n')
        # torch.Size([32, 128, 691, 10])
        ...
        x_k_9 = self.conv_block2_kernel_9(x_k_9, pool_size=(1, 1), pool_type='avg')
        x_k_9 = F.dropout(x_k_9, p=0.2, training=self.training)
        # print(x_k_9.size())  # torch.Size([8, 128, 730, 44])

        x_k_9 = self.conv_block3_kernel_9(x_k_9, pool_size=(1, 1), pool_type='avg')
        x_k_9 = F.dropout(x_k_9, p=0.2, training=self.training)
        # print(x_k_9.size(), '\n')  # torch.Size([8, 256, 341, 8])

        x_k_9 = self.conv_block4_kernel_9(x_k_9, pool_size=(1, 1), pool_type='avg')
        x_k_9 = F.dropout(x_k_9, p=0.2, training=self.training)
        # print(x_k_9.size(), '\n')
        ...
        x_k_3 = self.conv_block3_loudness(x_k_3, pool_size=(1, 1), pool_type='avg')
        x_k_3 = F.dropout(x_k_3, p=0.2, training=self.training)
        # print(x_k_3.size(), '\n')  # torch.Size([64, 64, 1866, 1])

        x_k_3 = self.conv_block4_loudness(x_k_3, pool_size=(1, 1), pool_type='avg')
        x_k_3 = F.dropout(x_k_3, p=0.2, training=self.training)
        # print(x_k_3.size(), '\n')
        ...
        x_k_5 = self.conv_block3_kernel_5_loudness(x_k_5, pool_size=(1, 1), pool_type='avg')
        x_k_5 = F.dropout(x_k_5, p=0.2, training=self.training)
        # print(x_k_5.size(), '\n')  # torch.Size([64, 64, 1858, 1])

        x_k_5 = self.conv_block4_kernel_5_loudness(x_k_5, pool_size=(1, 1), pool_type='avg')
        x_k_5 = F.dropout(x_k_5, p=0.2, training=self.training)
        # print(x_k_5.size(), '\n')
        ...
        x_k_7 = self.conv_block3_kernel_7_loudness(x_k_7, pool_size=(1, 1), pool_type='avg')
        x_k_7 = F.dropout(x_k_7, p=0.2, training=self.training)
        # print(x_k_7.size(), '\n')  # torch.Size([64, 64, 1849, 1])

        x_k_7 = self.conv_block4_kernel_7_loudness(x_k_7, pool_size=(1, 1), pool_type='avg')
        x_k_7 = F.dropout(x_k_7, p=0.2, training=self.training)
        # print(x_k_7.size(), '\n')  # torc
        ...
        x_k_9 = self.conv_block3_kernel_9_loudness(x_k_9, pool_size=(1, 1), pool_type='avg')
        x_k_9 = F.dropout(x_k_9, p=0.2, training=self.training)
        # print(x_k_9.size(), '\n')  # torch.Size([64, 64, 1841, 1])

        x_k_9 = self.conv_block4_kernel_9_loudness(x_k_9, pool_size=(1, 1), pool_type='avg')
        x_k_9 = F.dropout(x_k_9, p=0.2, training=self.training)
        # print(x_k_9.size(), '\n')  # to
        ...
        kernels_embs = torch.cat([mel_k3, mel_k5, mel_k7, mel_k9, loudness_k3, loudness_k5, loudness_k7, loudness_k9],
                                 dim=0)
        # torch.Size([8, 16, 64])  (node_num, batch, dim)
        kernels_embs = kernels_embs.transpose(0, 1)
        ...
        common_embeddings = F.gelu(
            self.fc_all_nodes_to_classification_embeddings(kernels_embs))  # torch.Size([8, 8 * 64]) (batch, num)
...
class SoundAQnet_block5(nn.Module):
    def __init__(self, max_node_num, node_emb_dim=256,
                 hidden_dim=32,
                 out_dim=64,
                 n_layers=3,
        ...
        super(SoundAQnet_block5, self).__init__()
        ...
        self.conv_block3 = ConvBlock_dilation(in_channels=32, out_channels=64, padding=(0, 0), dilation=(3, 1))
        self.conv_block4 = ConvBlock_dilation(in_channels=64, out_channels=128, padding=(1, 1))
        self.conv_block5 = ConvBlock_dilation(in_channels=128, out_channels=256, padding=(1, 1))
        self.k_3_freq_to_1 = nn.Linear(frequency_num, frequency_emb_dim, bias=True)
        ...
        self.conv_block4_kernel_5 = ConvBlock_dilation(in_channels=64, out_channels=128,
                                                       kernel_size=kernel_size, padding=(0, 2))
        self.conv_block5_kernel_5 = ConvBlock_dilation(in_channels=128, out_channels=256,
                                                       kernel_size=kernel_size, padding=(0, 2))
        self.k_5_freq_to_1 = nn.Linear(frequency_num, frequency_emb_dim, bias=True)
        ...
        self.conv_block4_kernel_7 = ConvBlock_dilation(in_channels=64, out_channels=128,
                                                       kernel_size=kernel_size, padding=(0, 3))
        self.conv_block5_kernel_7 = ConvBlock_dilation(in_channels=128, out_channels=256,
                                                       kernel_size=kernel_size, padding=(0, 3))
        self.k_7_freq_to_1 = nn.Linear(frequency_num, frequency_emb_dim, bias=True)
        ...
        self.conv_block4_kernel_9 = ConvBlock_dilation(in_channels=64, out_channels=128,
                                                       kernel_size=kernel_size, padding=(0, 4))
        self.conv_block5_kernel_9 = ConvBlock_dilation(in_channels=128, out_channels=256,
                                                       kernel_size=kernel_size, padding=(0, 4))
        self.k_9_freq_to_1 = nn.Linear(3, frequency_emb_dim, bias=True)
        ...
        self.conv_block4_loudness = ConvBlock_dilation(in_channels=64, out_channels=128,
                                                       kernel_size=(3, 1), padding=(0, 0))
        self.conv_block5_loudness = ConvBlock_dilation(in_channels=128, out_channels=256,
                                                       kernel_size=(3, 1), padding=(0, 0))
        ...
        self.conv_block4_kernel_5_loudness = ConvBlock_dilation(in_channels=64, out_channels=128,
                                                                kernel_size=kernel_size, padding=(0, 0))
        self.conv_block5_kernel_5_loudness = ConvBlock_dilation(in_channels=128, out_channels=256,
                                                                kernel_size=kernel_size, padding=(0, 0))
        ...
        self.conv_block4_kernel_7_loudness = ConvBlock_dilation(in_channels=64, out_channels=128,
                                                                kernel_size=kernel_size, padding=(0, 0))
        self.conv_block5_kernel_7_loudness = ConvBlock_dilation(in_channels=128, out_channels=256,
                                                                kernel_size=kernel_size, padding=(0, 0))
        ...
        self.conv_block4_kernel_9_loudness = ConvBlock_dilation(in_channels=64, out_channels=128,
                                                                kernel_size=kernel_size, padding=(0, 0))
        self.conv_block5_kernel_9_loudness = ConvBlock_dilation(in_channels=128, out_channels=256,
                                                                kernel_size=kernel_size, padding=(0, 0))
        ...
        # self.embedding_h = nn.Linear(in_dim, hidden_dim)
        self.embedding_h = nn.Linear(256, hidden_dim)
    ...
    def forward(self, input, batch_x_loudness, batch_graph):
        ...
        """
       x_k_3: torch.Size([32, 64, 734, 10]) 

x_k_3: torch.Size([32, 128, 730, 6]) 

x_k_3: torch.Size([32, 256, 726, 2]) 

x_k_5: torch.Size([32, 64, 716, 24]) 

x_k_5: torch.Size([32, 128, 700, 16]) 

x_k_5: torch.Size([32, 256, 684, 4]) 

x_k_7: torch.Size([32, 64, 699, 28]) 

x_k_7: torch.Size([32, 128, 675, 16]) 

x_k_7: torch.Size([32, 256, 651, 4]) 

x_k_9: torch.Size([32, 64, 2905, 60]) 

x_k_9: torch.Size([32, 128, 2873, 22]) 

x_k_9: torch.Size([32, 256, 2841, 3]) 
        ...
        x_k_3 = self.conv_block3(x_k_3, pool_size=(1, 1), pool_type='avg')
        x_k_3 = F.dropout(x_k_3, p=0.2, training=self.training)
        # print('x_k_3:', x_k_3.size(), '\n')  # torch.Size([32, 64, 367, 44])

        x_k_3 = self.conv_block4(x_k_3, pool_size=(1, 1), pool_type='avg')
        x_k_3 = F.dropout(x_k_3, p=0.2, training=self.training)
        # print('x_k_3:', x_k_3.size(), '\n')

        x_k_3 = self.conv_block5(x_k_3, pool_size=(1, 1), pool_type='avg')
        x_k_3 = F.dropout(x_k_3, p=0.2, training=self.training)
        # print('x_k_3:', x_k_3.size(), '\n')
        ...
        x_k_5 = self.conv_block2_kernel_5(x_k_5, pool_size=(2, 1), pool_type='avg')
        x_k_5 = F.dropout(x_k_5, p=0.2, training=self.training)
        # print(x_k_5.size())  # torch.Size([8, 128, 740, 52])

        x_k_5 = self.conv_block3_kernel_5(x_k_5, pool_size=(1, 1), pool_type='avg')
        x_k_5 = F.dropout(x_k_5, p=0.2, training=self.training)
        # print('x_k_5:', x_k_5.size(), '\n')  # torch.Size([8, 256, 358, 32])

        x_k_5 = self.conv_block4_kernel_5(x_k_5, pool_size=(1, 1), pool_type='avg')
        x_k_5 = F.dropout(x_k_5, p=0.2, training=self.training)
        # print('x_k_5:', x_k_5.size(), '\n')

        x_k_5 = self.conv_block5_kernel_5(x_k_5, pool_size=(1, 2), pool_type='avg')
        x_k_5 = F.dropout(x_k_5, p=0.2, training=self.training)
        # print('x_k_5:', x_k_5.size(), '\n')
        ...
        x_k_7 = self.conv_block2_kernel_7(x_k_7, pool_size=(2, 1), pool_type='avg')
        x_k_7 = F.dropout(x_k_7, p=0.2, training=self.training)
        # print(x_k_7.size())  # torch.Size([8, 128, 735, 48])

        x_k_7 = self.conv_block3_kernel_7(x_k_7, pool_size=(1, 1), pool_type='avg')
        x_k_7 = F.dropout(x_k_7, p=0.2, training=self.training)
        # print('x_k_7:', x_k_7.size(), '\n')  # torch.Size([8, 256, 349, 20])
        ...
        x_k_7 = self.conv_block5_kernel_7(x_k_7, pool_size=(1, 1), pool_type='avg')
        x_k_7 = F.dropout(x_k_7, p=0.2, training=self.training)
        # print('x_k_7:', x_k_7.size(), '\n')
        ...
        # kernel 9 -----------------------------------------------------------------------------------------------------
        x_k_9 = self.conv_block1_kernel_9(batch_x, pool_size=(1, 1), pool_type='avg')
        x_k_9 = F.dropout(x_k_9, p=0.2, training=self.training)
        # print(x_k_9.size())  # torch.Size([8, 64, 1492, 64])
        ...
        x_k_9 = self.conv_block3_kernel_9(x_k_9, pool_size=(1, 1), pool_type='avg')
        x_k_9 = F.dropout(x_k_9, p=0.2, training=self.training)
        # print('x_k_9:',x_k_9.size(), '\n')  # torch.Size([8, 256, 341, 8])

        x_k_9 = self.conv_block4_kernel_9(x_k_9, pool_size=(1, 2), pool_type='avg')
        x_k_9 = F.dropout(x_k_9, p=0.2, training=self.training)
        # print('x_k_9:',x_k_9.size(), '\n')

        x_k_9 = self.conv_block5_kernel_9(x_k_9, pool_size=(1, 2), pool_type='avg')
        x_k_9 = F.dropout(x_k_9, p=0.2, training=self.training)
        # print('x_k_9:', x_k_9.size(), '\n')
        ...
        x_k_3 = self.conv_block5_loudness(x_k_3, pool_size=(1, 1), pool_type='avg')
        x_k_3 = F.dropout(x_k_3, p=0.2, training=self.training)
        # print(x_k_3.size(), '\n')
        ...
        x_k_5 = self.conv_block5_kernel_5_loudness(x_k_5, pool_size=(1, 1), pool_type='avg')
        x_k_5 = F.dropout(x_k_5, p=0.2, training=self.training)
        # print(x_k_5.size(), '\n')
        ...
        x_k_7 = self.conv_block5_kernel_7_loudness(x_k_7, pool_size=(1, 1), pool_type='avg')
        x_k_7 = F.dropout(x_k_7, p=0.2, training=self.training)
        # print(x_k_7.size(), '\n')  # torc
        ...
        x_k_9 = self.conv_block5_kernel_9_loudness(x_k_9, pool_size=(1, 1), pool_type='avg')
        x_k_9 = F.dropout(x_k_9, p=0.2, training=self.training)
        # print(x_k_9.size(), '\n')  # to
