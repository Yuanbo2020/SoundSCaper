...
def main(argv):
    ...
    # alpha = [ "1 1 1 1 0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.5"]
    # alpha = [ "1 1 0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.5"]
    ...
    Training_early_stopping(generator, model, models_dir, batch_size, monitor, alpha=alpha)
