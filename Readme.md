...
2) Use the code in [Feature_log_mel](Feature_log_mel) to extract log mel acoustic features; use the code in Feature_loudness_ISO532_1 to extract the ISO 532-1:2017 standard loudness features.
...
The trained models of the other 7 models in Table V in the paper have been attached to their respective folders. 
